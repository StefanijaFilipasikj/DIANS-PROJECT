...
public class HomeController {
    ...
    private String getPage(Model model){
        List<HistoricLandmark> landmarks = Arrays.asList(Objects.requireNonNull(
                RequestHelper.sendGetRequestForLandmarks(RequestHelper.createRequestUrl("/top-10-landmarks", new HashMap<>())).getBody()));
